...
impl GameState
{
    ...
    fn produce_pawn_moves(pos:Point, player:&Player, game:&GameState, moves: &mut Vec<Move>)
    {
    ...
    fn produce_knight_moves(pos:Point, player:&Player, game:&GameState, moves: &mut Vec<Move>)
    {
        for i in 0..4{
            let x_dir = (i/2)*2-1;
            let y_dir = (i%2)*2-1;
    ...
    fn produce_bishop_moves(pos:Point, player:&Player, game:&GameState, moves: &mut Vec<Move>)
    {
        for i in 0..4{ GameState::produce_moves_for_dir(pos,player,game,moves,(i/2)*2-1, (i%2)*2-1) }
    }

    fn produce_rook_moves(pos:Point, player:&Player, game:&GameState, moves: &mut Vec<Move>)
    {
        for (x_dir, y_dir) in vec![ (0,1), (1,0), (0,-1), (-1,0) ]{ GameState::produce_moves_for_dir(pos,player,game,moves,x_dir, y_dir) }
    }

    fn produce_queen_moves(pos:Point, player:&Player, game:&GameState, moves: &mut Vec<Move>)
    {
        GameState::produce_rook_moves(pos,player,game,moves);
        GameState::produce_bishop_moves(pos,player,game,moves);
    }
    ...
    fn produce_no_moves(pos:Point, player:&Player, game:&GameState, moves: &mut Vec<Move>) {}
